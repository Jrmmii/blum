...
while True:
    ...
    print(Fore.YELLOW + Style.BRIGHT + f"1. Logic Trader")
    print(Fore.YELLOW + Style.BRIGHT + f"2. Logic Trader juga :) (Public)")
    ...
    if tribe_selection == "1":
        tribe_id = "df46957e-27e7-4e32-9ed7-005764564c0a"
        break
    elif tribe_selection == "2":
        tribe_id = "df46957e-27e7-4e32-9ed7-005764564c0a"
        break
    elif tribe_selection == "3":
        print(Fore.YELLOW + Style.BRIGHT + "HAH !!! PELITTT !!!, MODIF THE CODE BY YOURSELF IF YOU WANT TO CUSTOM JOIN THE TRIBE !!")
        print(Fore.YELLOW + Style.BRIGHT + "Using default tribe: Logic Trader Ajalah")
        tribe_id = "df46957e-27e7-4e32-9ed7-005764564c0a"
        break
    else:
            ...
            while balance_info['playPasses'] > 0:
                ...
                while True:
                    if claim_response is None:
                        ...
                        claim_response = claim_game(token, game_response['gameId'], random.randint(201, 378))
                        if claim_response is None:
                            print(f"\r{Fore.RED+Style.BRIGHT}[ Play Game ] : Gagal mengklaim game, mencoba lagi...", flush=True)
